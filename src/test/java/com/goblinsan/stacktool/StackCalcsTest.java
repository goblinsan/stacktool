...
public class StackCalcsTest {
    ...
    private static Map<Integer, List> pointPercents;
    ...
    public void createGetProbeMarkings() {
        ...
        assertTrue(expectedList.equals(testObj.getProbeMarks(4, 0, 4)));

        expectedList = Arrays.asList(1, 2);

        assertTrue(expectedList.equals(testObj.getProbeMarks(2, 0, 2)));

        expectedList = Arrays.asList(2, 4);

        assertTrue(expectedList.equals(testObj.getProbeMarks(4, 0, 2)));

        expectedList = Arrays.asList(3, 5);

        assertTrue(expectedList.equals(testObj.getProbeMarks(4, 1, 2)));

        assertNotNull(pointPercents);
    }
}
